...
export const GENRE_CATALOG = [
  ...
  },
  {
    ...
    subtypes: [
      ...
      { id: 'biab_glam_rock_1_16th_rock', label: 'Glam Rock 1 - 16th Rock (BIAB)', bpm: 95, sty: '/styles/Custom/glam-rock-1-16th-rock.json', human: 'rock' },
      { id: 'biab_uptempo_gospel_style', label: 'Uptempo Gospel Style (BIAB)', bpm: 210, sty: '/styles/Custom/uptempo-gospel-style.json', human: 'pop' },
      { id: 'biab_mudy_slow_blues', label: 'Mudy Slow Blues (BIAB)', bpm: 65, sty: '/styles/Custom/mudy-slow-blues.json', human: 'blues' },
      { id: 'biab_motown_style', label: 'Motown Style (BIAB)', bpm: 170, sty: '/styles/Custom/motown-style.json', human: 'funk' },
      { id: 'biab_gemstone_34_smooth_jazz', label: 'Gemstone - 3/4 Smooth Jazz (BIAB)', bpm: 75, sty: '/styles/Custom/gemstone-34-smooth-jazz.json', human: 'jazz' },
      { id: 'biab_gritty_4_to_the_bar_shuffle', label: 'Gritty - 4-to-the-Bar Shuffle (BIAB)', bpm: 160, sty: '/styles/Custom/gritty-4-to-the-bar-shuffle.json', human: 'blues' },
      { id: 'biab_guaguanco_folk_traditional_cuban', label: 'Guaguanco Folk - Traditional Cuban (BIAB)', bpm: 102, sty: '/styles/Custom/guaguanco-folk-traditional-cuban.json', human: 'country' },
      { id: 'biab_guaguanco_modern_cuban_dance', label: 'Guaguanco Modern - Cuban Dance (BIAB)', bpm: 102, sty: '/styles/Custom/guaguanco-modern-cuban-dance.json', human: 'pop' },
      { id: 'biab_goodtime_smooth_jazz_groove', label: 'Good Time Smooth Jazz Groove (BIAB)', bpm: 95, sty: '/styles/Custom/goodtime-smooth-jazz-groove.json', human: 'jazz' },
      { id: 'biab_nitefall_easy_jazz_swing', label: 'Nitefall Easy Jazz Swing (BIAB)', bpm: 110, sty: '/styles/Custom/nitefall-easy-jazz-swing.json', human: 'jazz' },
      { id: 'biab_gossamer_2_acoustic_guitars', label: 'Gossamer 2 Acoustic Guitars (BIAB)', bpm: 80, sty: '/styles/Custom/gossamer-2-acoustic-guitars.json', human: 'pop' },
      { id: 'biab_grover_pop_style', label: 'Grover Pop Style (BIAB)', bpm: 90, sty: '/styles/Custom/grover-pop-style.json', human: 'pop' },
      { id: 'biab_gr_dead2_latin_folk', label: 'Gr Dead2 Even 8ths Latin Folk (BIAB)', bpm: 120, sty: '/styles/Custom/gr-dead2-latin-folk.json', human: 'latin' },
      { id: 'biab_guitar_funk_16ths', label: 'Guitar Funk Even 16ths Funky Rock (BIAB)', bpm: 120, sty: '/styles/Custom/guitar-funk-16ths.json', human: 'rock' },
      { id: 'biab_lullaby_slow_waltz', label: 'Lullaby Slow Waltz (BIAB)', bpm: 90, sty: '/styles/Custom/lullaby-slow-waltz.json', human: 'classical' },
      { id: 'biab_luna_huapango_34', label: 'Luna Huapango 3/4 Argentina (BIAB)', bpm: 85, sty: '/styles/Custom/luna-huapango-34.json', human: 'pop' },
      { id: 'biab_lynyrd_southern_rock', label: 'Lynyrd1 Bright Southern Stadium Rock (BIAB)', bpm: 125, sty: '/styles/Custom/lynyrd-southern-rock.json', human: 'rock' },
      { id: 'biab_luther1_country_2beat', label: 'Luther1 Fast Even 8th Country 2-Beat (BIAB)', bpm: 235, sty: '/styles/Custom/luther1-country-2beat.json', human: 'country' },
      { id: 'biab_movin_uptempo_jazz', label: 'Movin Uptempo Jazz Quintet (BIAB)', bpm: 165, sty: '/styles/Custom/movin-uptempo-jazz.json', human: 'jazz' },
      { id: 'biab_mozart_classical', label: 'Mozart Classical Style (BIAB)', bpm: 120, sty: '/styles/Custom/mozart-classical.json', human: 'pop' },
      { id: 'biab_mozart_orchestral_34', label: 'Mozart Orchestral 3/4 (BIAB)', bpm: 140, sty: '/styles/Custom/mozart-orchestral-34.json', human: 'pop' },
      { id: 'biab_mystery1_soundtrack_34', label: 'Mystery1 Mysterious 3/4 Soundtrack (BIAB)', bpm: 100, sty: '/styles/Custom/mystery1-soundtrack-34.json', human: 'pop' },
      { id: 'biab_nashville_g_country', label: 'Nashville G Country Swing (BIAB)', bpm: 80, sty: '/styles/Custom/nashville-g-country.json', human: 'jazz' },
      { id: 'biab_neal_country_rock_16ths', label: 'Neal Even 16ths Acoustic Country Rock (BIAB)', bpm: 80, sty: '/styles/Custom/neal-country-rock-16ths.json', human: 'rock' },
      { id: 'biab_new_jazz_1_medium_swing', label: 'New Jazz 1 Medium 4/4 Swing (BIAB)', bpm: 105, sty: '/styles/Custom/new-jazz-1-medium-swing.json', human: 'jazz' },
      { id: 'biab_newone_jazz_swing', label: 'New One Jazz Swing (BIAB)', bpm: 175, sty: '/styles/Custom/newone-jazz-swing.json', human: 'jazz' },
      { id: 'biab_newport_la_pop_jazz', label: 'Newport LA Pop Jazz (BIAB)', bpm: 64, sty: '/styles/Custom/newport-la-pop-jazz.json', human: 'jazz' },
      { id: 'biab_bucky_nashville_rock', label: 'Bucky Nashville Rock+ (BIAB)', bpm: 126, sty: '/styles/Custom/bucky-nashville-rock.json', human: 'rock' },
      { id: 'biab_gret_shuffle_nashville_rock', label: 'GRET Shuffle Nashville Rock+ (BIAB)', bpm: 76, sty: '/styles/Custom/gret-shuffle-nashville-rock.json', human: 'blues' },
      { id: 'biab_norj_128_nashville_rock', label: 'NORJ 12/8 Nashville Rock+ (BIAB)', bpm: 65, sty: '/styles/Custom/norj-128-nashville-rock.json', human: 'rock' },
      { id: 'biab_fusion_soft', label: 'Fusion Soft (BIAB)', bpm: 96, sty: '/styles/Custom/fusion-soft.json', human: 'jazz' }
    ],
  },
]
